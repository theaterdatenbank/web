...
EinzelnesEventComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: EinzelnesEventComponent, selectors: [["app-einzelnes-event"]], inputs: { dasEvent: "dasEvent" }, decls: 16, vars: 3, consts: [[1, "dasEventContainer"], [1, "itemDate"], [1, "itemDateDay"], [1, "itemDateMonth"], [1, "itemPicture"], ["alt", "vorschau", 3, "src"], [1, "itemEventinfo"], [1, "itemEventinfoMore"], [1, "itemCheckbox"], ["type", "checkbox", "id", "merken", "name", "merken", 3, "value"]], template: function EinzelnesEventComponent_Template(rf, ctx) { if (rf & 1) {
