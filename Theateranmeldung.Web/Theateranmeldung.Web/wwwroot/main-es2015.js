...
EinzelnesEventComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: EinzelnesEventComponent, selectors: [["app-einzelnes-event"]], inputs: { dasEvent: "dasEvent" }, outputs: { checkedEvent: "checkedEvent" }, decls: 16, vars: 8, consts: [[1, "dasEventContainer"], [1, "itemDate"], [1, "itemDateDay"], [1, "itemDateMonth"], [1, "itemPicture", 3, "click"], ["alt", "vorschau", 3, "src"], [1, "itemEventinfo", 3, "click"], [1, "itemEventinfoMore", 3, "hidden"], [1, "itemCheckbox"], [3, "value", "change"]], template: function EinzelnesEventComponent_Template(rf, ctx) { if (rf & 1) {
...
SearchMenuComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: SearchMenuComponent, selectors: [["app-search-menu"]], inputs: { count: "count" }, outputs: { gefundeneEvents: "gefundeneEvents", showCheckboxedEvents: "showCheckboxedEvents" }, decls: 7, vars: 5, consts: [["fxLayout", "row wrap", "fxLayoutGap", "32px", "fxLayoutAlign", "flex-start", "fxLayout.lt-sm", "column", "fxFlex", "1 1 0", 1, "searchMenu-flex-container"], ["fxFlex.lt-md", "0 1 calc(50% - 32px)", "fxFlex.lt-sm", "100%", 1, "searchMenu-element", "searchMenu-willIch"], ["placeholder", "Will ich", 3, "label", "mappingFunction", "value", "enterPressed"], ["fxFlex.lt-md", "0 1 calc(50% - 32px)", "fxFlex.lt-sm", "100%", 1, "searchMenu-element", "searchMenu-willIchNicht"], ["placeholder", "Will ich nicht", 3, "label", "mappingFunction", "value", "enterPressed"], [1, "searchMenu-element", "favouriteCounter"], [3, "count", "showSelectedEvents"]], template: function SearchMenuComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 0);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](1, "div", 1);
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("showSelectedEvents", function SearchMenuComponent_Template_app_marked_event_counter_showSelectedEvents_6_listener($event) { return ctx.showSelectedEvents($event); });
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
    } if (rf & 2) {
